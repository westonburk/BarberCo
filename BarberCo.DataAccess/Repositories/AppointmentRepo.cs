...
#else
                // No Twilio account set up so don't try to send sms
            var appointment = await AddUnConfirmedAppointmentAsync(newAppointment, createdBy: "Website", sendConfirmationCode: false, token);
#endif
